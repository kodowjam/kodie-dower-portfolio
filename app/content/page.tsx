...
export default function ContentPortfolio() {
  const articles = [
    ...
    },
    {
      ...
      description: "How Credit Karma streamlined developer workflows and boosted productivity using Coder's cloud development environments.",
      url: "https://coder.com/blog/how-credit-karma-elevated-developer-productivity-with-coder",
    },
    {
      publication: "Coder",
      title: "What 100 Engineering Teams Revealed About AI Maturity and What to Do About It",
      description: "Key findings from Coder's AI Maturity Self-Assessment, completed by 100 engineering organizations, and what they mean for adoption.",
    ...
    },
    {
      ...
      description: "A look at building faster, more secure cloud development environments on AWS using Coder.",
    ...
    },
    {
      ...
      description: "Recapping Coder's company-wide hackathon, where teams built new tools on top of Coder's own platform.",
      url: "https://coder.com/blog/what-happens-when-you-let-the-whole-company-loose-on-your-own-product",
    },
    {
      publication: "Coder",
      title: "Financial Services Has an AI Governance Problem. Here's How Leading Institutions Are Solving It.",
      description: "How financial institutions are building AI governance controls to safely adopt AI-assisted development.",
    ...
    },
    {
      ...
      description: "Exploring how PsiQuantum uses Coder to build a development platform for quantum computing.",
    ...
    },
    {
      ...
      description: "Why defense and government organizations are redefining sovereignty around enforced control rather than physical isolation.",
    ...
    },
    {
      ...
      description: "How enterprises can scale AI coding agents without sacrificing governance and control.",
    ...
    },
    {
      ...
      description: "Why developer laptops are the softest target in the security stack, and how centralized environments reduce that risk.",
    ...
    },
    {
      ...
      description: "How enterprises get visibility and control over AI development infrastructure without compromising developer speed.",
    ...
    },
    {
      ...
      description: "Lessons on modern software supply chain security drawn from the Claude Code source leak and related incidents.",
